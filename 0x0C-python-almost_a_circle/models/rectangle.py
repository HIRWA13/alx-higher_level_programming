...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Attributes:
            width (int): a Private attribute for the width of the Rectangle
            height (int): a  Private attribute for the height of the Rectangle
            x (int): a Private attribute for x value of the Rectangle
            y (int): a Private attribute for y value of the Rectangle
            id (int): a Private attribute id inherits from Base
        """
        super().__init__(id)
        self.width = width
        self.height = height
